...
public class ATM{
    public static void main(String[] args){
        ...
        // init Bank
        Bank theBank = new Bank("Bank of Eric");

        // adding a User, also makes a savings acct
        User aUser = theBank.addUser("Eric", "Nguyen", "1234");

        // add checking acct for user
        ...
        while(true){
            // login prompt until successful
            currentUser = ATM.mainMenuPrompt(theBank, sc);

            // stay in menu until user wants to quit
